    ...
    constructor(){
        listaLeyendas = mutableListOf(
                ...
                Leyenda(1, "Leyenda de la Puerta de la Justicia",
                        ...
                        "Recorrido 1"),
                Leyenda(1, "Leyenda de la sala  Abencerrajes",
                ...
                Leyenda(1, "Leyenda de la silla del moro",
                        ...
                        "Recorrido 1"),
                Leyenda(1, "Leyenda de la torre de la cautiva",
                        ...
                        "Recorrido 1"),
                Leyenda(1, "Leyenda del ciprés de la sultana",
                ...
                Leyenda(1,
                        ...
                        "Recorrido 1"),
                Leyenda(1, "Leyenda del origen del nombre 'Alhambra'",
                        ...
                        "Recorrido 1"),
                Leyenda(1, "Leyenda de los azulejos de Mexuar",
